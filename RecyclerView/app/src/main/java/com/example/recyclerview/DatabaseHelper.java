...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME="UserInfo";  private static final String TABLE_NAME="tbl_user";  private static final String KEY_NAME="name";  private static final String KEY_AGE="age";
    ...
    public void update(PersonBean personBean){
        ...
        ContentValues values=new ContentValues();
        values.put(KEY_AGE,personBean.getAge());
        String whereClause=KEY_NAME+"='"+personBean.getName()+"'";  db.update(TABLE_NAME,values,whereClause,null);
    }
}
